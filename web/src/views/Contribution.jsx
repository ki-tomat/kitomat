...
function AgentStep({ files, agentRun, setAgentRun }) {
  ...
  return (
    <div>
      {!agentRun ? (
        <div style={{padding:"24px 28px", background:"linear-gradient(135deg, var(--ink), var(--tomato-deep))", borderRadius:14, color:"white", display:"flex", alignItems:"center", gap:18, marginBottom:18}}>
        ...
        <div style={{padding:"18px 22px", background:"var(--leaf-soft)", border:"1px solid var(--leaf-border)", borderRadius:14, color:"var(--leaf-ink)", display:"flex", alignItems:"center", gap:14, marginBottom:18}}>
