  ...
  return (
    <div className="page">
      <div className="container">
        ...
        {/* Rewards teaser */}
        <div className="card" style={{padding:24, display:"flex", justifyContent:"space-between", alignItems:"center", flexWrap:"wrap", gap:14, background:"linear-gradient(135deg, var(--amber-soft), var(--surface))", border:"1px solid var(--amber-border)"}}>
